...
func (q *PlainTextQuery) init() {
	q.maxTextWords = 100 // to reduce ES timeout and decrease latency
}

func (q PlainTextQuery) CreateQuery(_ context.Context, searchDict map[string]interface{}, additionalFilter map[string]interface{}) (bytes.Buffer, error) {
				...
				"should": []map[string]interface{}{
					{
						"multi_match": map[string]interface{}{
							"query":                searchText,
							"fields":               []string{"question_plain.shingles"},
							"boost":                0.3,
							"fuzziness":            "AUTO",
							"minimum_should_match": "55%",
						},
